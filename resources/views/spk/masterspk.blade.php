						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr id="{{ $krit->id }}">
									...
									<td name="bobot_id"><span class="hide" >{{ $krit->bobott->id }}</span>{{ $krit->bobott->bobot }}</td>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr id="{{ $varz->id }}">
									...
									<td name="bobott"><span class="hide" >{{ $varz->bobott->id }}</span>{{ $varz->bobott->nama_bobot }} ({{ $varz->bobott->bobot }})</td>
									<td  style="width: 10%">
