...
<div class="form-group col-md-6{{ $errors->has('no_kk') ? ' has-error' : '' }}"> 
	{!! Form::label('no_kk', 'Nomor KK', ['class'=>'col-md-4 control-label', 'style'=>'text-align: right;']) !!}
	<div class="col-md-8"> 
		{!! Form::text('no_kk', null, ['class'=>'form-control','placeholder'=>'Nomor KK']) !!} 
		<strong>{!! $errors->first('no_kk', '<p class="help-block">:message</p>') !!}</strong>
	</div> 
</div>

<div class="form-group col-md-6{{ $errors->has('alamat') ? ' has-error' : '' }}"> 
	{!! Form::label('alamat', 'Alamat', ['class'=>'col-md-4 control-label', 'style'=>'text-align: right;']) !!} 
	<div class="col-md-8"> 
		{!! Form::text('alamat', null, ['class'=>'form-control','placeholder'=>'Alamat']) !!}
		<strong>{!! $errors->first('alamat', '<p class="help-block">:message</p>') !!}</strong> 
	</div> 
</div>

<div class="form-group col-md-6{{ $errors->has('rt_id') ? ' has-error' : '' }}">
	{!! Form::label('rt_id', 'RT', ['class'=>'col-md-4 control-label', 'style'=>'text-align: right;']) !!}
	<div class="col-md-8">
		{!! Form::select('rt_id',$rt,null,['class' => 'form-control','placeholder' =>'-RT-']) !!}
		<strong>{!! $errors->first('rt_id', '<p class="help-block">:message</p>') !!}</strong>
	</div>
</div>

<div class="form-group col-md-6{{ $errors->has('rw_id') ? ' has-error' : '' }}">
	{!! Form::label('rw_id', 'RW', ['class'=>'col-md-4 control-label', 'style'=>'text-align: right;']) !!}
	<div class="col-md-8">
		{!! Form::select('rw_id',$rw,null,['class' => 'form-control','placeholder' =>'-RW-']) !!}
		<strong>{!! $errors->first('rw_id', '<p class="help-block">:message</p>') !!}</strong>
	</div>
</div>

<div class="col-md-12"><hr>
	<h3>Data Kepala Keluarga</h3>
	<small><i>**Data Kepala Keluarga wajib diisi!</i></small>
	<hr>
</div>
...
<div class="col-md-12">
	...
	<div class="form-group{{ $errors->has('akta_lahir') ? ' has-error' : '' }}"> 
		...
		<div class="col-md-12">
			<label>
				<input type="radio" name="akta_lahir" value="Ada"> Ada
				<!-- NO AKTA LAHIR -->
	...
	<div class="form-group{{ $errors->has('akta_kawin') ? ' has-error' : '' }}"> 
	    ...
	    <div class="col-md-12">
	        <label>
	          	<input type="radio" name="akta_kawin" value="Ada"> Ada
	          	<!-- NO AKTA LAHIR -->
	...
	<div class="form-group{{ $errors->has('akta_cerai') ? ' has-error' : '' }}"> 
	  	...
	  	<div class="col-md-12">
	    	<label>
	      		<input type="radio" name="akta_cerai" value="Ada"> Ada
	          	<!-- NO AKTA LAHIR -->
...
<div class="col-md-12">
    ...
    <div class="form-group{{ $errors->has('shdk_id') ? ' has-error' : '' }} col-md-4">
      	...
      	<div class="col-md-10">
        	{!! Form::select('shdk_id',$shdk,null,['class' => 'form-control','placeholder' =>'Kepala Keluarga', 'readonly', 'disabled']) !!}
