...
<div class="col-md-12">
	<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-12 control-label" style="text-align: left;">Nomor KK</label>
			<div class="col-md-12">
				<input type="text" name="" value="{{ $kel->no_kk }}" class="form-control" readonly="">
			</div>
			<input type="hidden" name="kk_id" value="{{ $kel->id_kk }}">
		</div>
