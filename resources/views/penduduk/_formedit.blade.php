...
<div class="col-md-12">
  <div class="col-md-4">
    ...
    <div class="form-group{{ $errors->has('kk_id') ? ' has-error' : '' }}">
      {!! Form::label('kk_id', 'No KK', ['class'=>'col-md-12 control-label required', 'style'=>'text-align: left']) !!}
      <div class="col-md-12">
        {!! Form::text('',$penduduk->kk->no_kk, ['class' => 'form-control','placeholder' =>'--Nomor KK--', 'readonly']) !!}
        {!! Form::hidden('kk_id',null, ['class' => 'form-control','placeholder' =>'--Nomor KK--']) !!}
        {!! $errors->first('kk_id', '<p class="help-block">:message</p>') !!}
      </div>
    </div>
    @endif
...
<div class="col-md-12">
    ...
    @if($penduduk->shdk_id != 1)
      ...
      <div class="form-group{{ $errors->has('shdk_id') ? ' has-error' : '' }} col-md-4">
        {!! Form::label('shdk_id', 'SHDK', ['class'=>'col-md-2 control-label']) !!}
        <div class="col-md-10">
          {!! Form::text('',$penduduk->shdk->shdk, ['class' => 'form-control','placeholder' =>'--Nomor KK--', 'readonly']) !!}
          {!! Form::hidden('shdk_id',null, ['class' => 'form-control','placeholder' =>'--Nomor KK--']) !!}
          {!! $errors->first('kk_id', '<p class="help-block">:message</p>') !!}
        </div>
      </div>
    @endif
